...
Xentinela listens with consent, follows the conversation as it develops, and tells the
...
![Xentinela setup screen](docs/images/setup.png)
...
So Xentinela re-reads the whole transcript every few seconds and revises its assessment as
...
<img src="docs/images/call-phone.png" width="340" alt="Xentinela on a phone during a call">
